...
def get_hyperparam_grid() -> dict:
    ...
    # n_estimators = [int(x) for x in np.linspace(start=200, stop=8000, num=3)]
...
if __name__ == "__main__":
    ...
    print("Starting to rebalance data..")
    X_balanced, y_balanced = rebalance_classes(X_train, y_train)
    print("Starting to run random grid search..")
    rn_grid = get_hyperparam_grid()
